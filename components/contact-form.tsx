...
const GetInvolvedSection: React.FC<FooterProps> = ({
  logoSrc,
  ...
  return (
    ...
    >
      <motion.section
        className="w-full  text-white font-[Tahoma] relative overflow-hidden mx-auto mt-16 sm:mt-10  lg:mt-20 px-4 lg:px-35 py-4 lg:pt-35"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.5 }}
        variants={sectionVariants}
        ...
        <div className="relative  mx-auto flex flex-col md:flex-row gap-12">
          ...
          <div className="md:w-1/2 space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold">
              <AnimatedText text="Get Involved" />
            </h2>
            <div className="text-white text-base md:text-lg leading-relaxed">
              <AnimatedText
                text=" We welcome collaboration with donors, investors, and institutions
              that share our vision for sustainable development and community
              empowerment. Contact our team to explore partnership
              opportunities."
              />
            </div>
          </div>
          ...
          <div className="md:w-1/2 bg-transparent">
            <form className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col">
                <label className="text-sm text-white mb-1">
                  <AnimatedText text="Company Address (Emirate, City, Address)" />
                </label>
                <input
                  type="text"
              ...
              <div className="flex flex-col">
                <label className="text-sm text-white mb-1">
                  <AnimatedText text="Company Number (Optional)" />
                </label>
                <input
                  type="text"
                  placeholder="+971 321 4567543"
              ...
              <div className="flex flex-col md:col-span-2">
                <label className="text-sm text-white mb-1">
                  <AnimatedText text="Company Trade License" />
                </label>
                <input
                  type="text"
                  placeholder="Lorem Ipsum"
              ...
              <div className="flex flex-col md:col-span-2">
                <label className="text-sm text-white mb-1">
                  <AnimatedText text="Municipality developer registration details" />
                </label>
                <textarea
                  rows={4}
      ...
      <div className="border border-white w-full h-[0.1px] my-20"></div>

      <motion.section
        className="w-full  text-white font-[Tahoma] relative overflow-hidden mx-auto px-4 lg:px-35"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.5 }}
        variants={sectionVariants}
      >
        <footer className="w-full text-white font-[Tahoma]">
          <div className="">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
              ...
              <div className="md:col-span-6">
                <div className="h-10 relative w-[190px]">
                  <Image
                    src={"/images/FooterAwqafCapitalLogo.svg"}
                ...
                <div className="mt-15 text-sm leading-relaxed text-white font-medium max-w-md">
                  <AnimatedText text="General Authority of Islamic Affairs," />
                  <br />
                  <AnimatedText text="Endowments and Zakat Building - Bani" />
                  <br />
                  <AnimatedText text="Yas East" />
                  <br />
                  <AnimatedText text="8008222" />
                  <br />
                  <AnimatedText text="info@awqaf.gov.ae" />
                </div>
              </div>

              <div className="md:col-span-6 row justify-between">
                {/* Middle: Useful links */}
                <div className="md:col-span-4">
                  <h4 className="text-sm tracking-wide text-white  font-bold uppercase">
                    <AnimatedText text="Useful Links" />
                  </h4>
                  <ul className="mt-4 space-y-3 text-[15px]">
                    <li>
                      <a
                        href="#about"
                        className="hover:text-white/80 text-[14px] text-white "
                      >
                        <AnimatedText text="About Awqaf" />
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        className="hover:text-white/80 text-[14px] text-white "
                      >
                        <AnimatedText text="Investment Opportunities" />
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        className="hover:text-white/80 text-[14px] text-white "
                      >
                        <AnimatedText text="News and Events" />
                      </a>
                    </li>
                    <li>
                      <a
                ...
                <div className="md:col-span-3">
                  {/* <h4 className="text-sm tracking-wide text-[#fff]  font-bold uppercase">
                      Social Media
                    </h4>
                  ...
                  >
                    ...
                    <span>
                      <AnimatedText text="Visit Awqaf Abu Dhabi" />
                    </span>
                  </button>
                </div>
              </div>
