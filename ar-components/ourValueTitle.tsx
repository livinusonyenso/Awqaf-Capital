        ...
        <div className="mx-auto">
          <div className="max-w-3xl">
            ...
            <p className="text-base leading-7 text-white/90">
              تأسست "أوقاف كابيتال" لإدارة وتنمية واستدامة الأصول الوقفية بما
              يتماشى مع الرؤية طويلة المدى لإمارة أبوظبي. وتجسّد هذه المبادرة
              التزام الإمارة بتحويل إدارة الأوقاف إلى محرّكٍ للرخاء والاستدامة
              ورفاه المجتمع.
            </p>
          </div>
        </div>
