...
export default function QuoteBlock({
  ...
  imageAlt = "Portrait",
  quote = `
تُجسّد أوقاف كابيتال التزامنا بالابتكار في الأسواق المالية، وإيماننا بأن" الاستثمار" 
"قادر على تحقيق التميّز المالي والمساهمة في التقدّم الاجتماعي معًا`,
  title = "المدير العام لهيئة الأوقاف وإدارة أموال القُصّر (أوقاف أبوظبي)",
  name = `سعادة فهد عبدالقادر القاسم`,
  className = "",
}: QuoteBlockProps) {
  return (
